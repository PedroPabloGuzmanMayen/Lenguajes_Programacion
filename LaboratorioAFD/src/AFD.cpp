...
//     AFD automata("q0", {1,4}, Alfabeto, estados);

//     automata.agregarTransicion("q0", "b", "q2");
//     automata.agregarTransicion("q0", "a", "q1");

//     automata.agregarTransicion("q2", "b", "q2");
//     automata.agregarTransicion("q2", "a", "q1");

//     automata.agregarTransicion("q1", "b", "q4");
//     automata.agregarTransicion("q1", "a", "q3");

//     automata.agregarTransicion("q4", "a", "q3");
//     automata.agregarTransicion("q4", "b", "q3");
